...
namespace Ikra_Is_Yonetim.DAL.Repo
{
    public class UnitOfRepo : IDisposable
    {
        ...
        private EFRepo<Malzeme> malzemeRepo;
        private EFRepo<SiparisOdeme> odemeRepo;
        public EFRepo<SiparisOdeme> odemeRepository
        {
            get
            {
        ...
        public EFRepo<Musteriler> musterilerRepository
        {
            ...
            {
                return
                    this.musteriRepo ??new EFRepo<Musteriler>(context);
            }
        }
